...
var atlas = {
	"recta" : preload("res://Sprites/vias/recta.png"),
	"curva" : preload("res://Sprites/vias/esquina.png"),
	"cruce t" : preload("res://Sprites/vias/t .png"),
	"cruce +" : preload("res://Sprites/vias/+ .png"),
	"ta' solo" : preload("res://Sprites/vias/via sola.png"),
	"final de via" : preload("res://Sprites/vias/final de via.png")
}
	...
	match Suma_direc():
		1:
			if abajo.is_colliding():
				Sprite.texture = atlas["final de via"]
				rotacionSprite(0)
